...
@section('content')
    ...
    <x-adminlte-modal id="deleteModal-{{$sponsor->id}}" title="Brisanje obroka"  theme="danger"
    ...
    <div class="d-flex pt-3">
        <a href="{{route('sponsor-edit', $sponsor)}}">
        ...
        <div class="col-md-6">
            <div class="card mb-4 shadow">
                <div class="position-relative">
                    <img src="{{asset($sponsor->image_url)}}" class="card-img-top rounded-top" alt="Food Image">
                    <div class="overlay"></div>
                    <h5 class="font-weight-bold px-3 pt-3">{{$sponsor->name}}</h5>
                </div>
                <div class="card-body">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <h6 class="card-subtitle mb-2 font-weight-bold">Lokacija:</h6>
                        <p class="card-text">{{$sponsor->location}}</p>
                    </div>
