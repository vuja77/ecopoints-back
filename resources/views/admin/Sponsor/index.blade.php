            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{route('sponsor-show', $sponsor)}}"
                        ...
                        <button class="btn btn-outline-danger ml-2 mr-2" data-toggle="modal" data-target="#deleteModal-{{$sponsor->id}}"><i class="fa fa-trash"></i></button>
                    </div>
                </td>
            </tr>
        @endforeach
