            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{route('favorite-show', $Favorite)}}"
                        ...
                        <button class="btn btn-outline-danger ml-2 mr-2" data-toggle="modal" data-target="#deleteModal-{{$Favorite->id}}"><i class="fa fa-trash"></i></button>
                    </div>
                </td>
            </tr>
        @endforeach
