...
@section('content')
    <form action="{{route('favorite-store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="name" name="user_id" placeholder="Unesite naziv obroka...">
        </div>
        <div class="mb-3">
            <label for="name" class="form-label">Id proizvoda</label>
            <input type="number" class="form-control" id="name" name="product_id" placeholder="Unesite naziv obroka...">
        </div>
