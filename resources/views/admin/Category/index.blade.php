            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center">
                        ...
                        <x-adminlte-modal id="deleteModal-{{$category->id}}" title="Brisanje obroka"  theme="danger"
                        ...
                        <button class="btn btn-outline-danger ml-2 mr-2" data-toggle="modal" data-target="#deleteModal-{{$category->id}}"><i class="fa fa-trash"></i></button>
                    </div>
                </td>
            </tr>
        @endforeach
